...
\begin{equation} \label{eq:ci_sim_matrix_cos}
    ...
    \end{aligned}
\end{equation}
i to właśnie te newsy, które reprezentowane są przez  niezerowe podobieństwa w pierwszym wiersszu 
...
Posiadając zdefiniowane $\mathbf{GI}$ możeny rozpocząć opis 
